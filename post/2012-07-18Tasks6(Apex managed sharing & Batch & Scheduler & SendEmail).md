To create a batch class to add one user (different user as yourself) into account team of all account of your personal org, with access level "Edit". On finish, it will send an Email to currentUser.
